    ...
    <Layout>
      <div class="main-container">
        <div id="home-container-1">
          ...
          />
          <hr />
          <div class="subtitle">Software Engineering Student Association</div>
        </div>
        ...
        <div id="mission">
          ...
          <hr />
          <p>
            Our mission is to provide a support group for software engineers and
            to define a group of people who see themselves connected in an
            important way. SESA strives to enrich student life while building a
            networking platform in order to aid students in landing real world
            experiences.
          </p>
        </div>
